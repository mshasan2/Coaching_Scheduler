...
export const bookSlot = (slotId, studentId) => async dispatch => {
  const res = await axios.post(`http://localhost:3000/slots/${slotId}/book`, { student_id: studentId });
